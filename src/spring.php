...
$courier = new Courier();
$courier->packagePDF($courier->newPackage($params, $order), 'GetShipmentLabel', $params['api_key']);
echo "<iframe src='label.pdf' style='width:100%; height:100%;' frameborder='0'></iframe>";
